...
import { CacheWatcher } from '../src/cache_watcher.js';
import {
  type ResolvedTelescopeWatchersConfig,
  type TelescopeWatchersConfig,
  resolveConfig,
} from '../src/define_config.js';
import type { EmitterLike, Watcher } from '../src/emitter.js';
import { LucidQueryWatcher } from '../src/lucid_query_watcher.js';
import { MailWatcher } from '../src/mail_watcher.js';
