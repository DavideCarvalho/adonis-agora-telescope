// Ported verbatim (only the import path changed) from `nestjs-telescope`'s
// `packages/core/src/profiling/aggregate-profile.ts` — pure aggregation math over the V8 Profiler
// protocol shape, with zero framework dependency.
