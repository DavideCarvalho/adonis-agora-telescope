// Ported near-verbatim (only the import path changed) from `nestjs-telescope`'s
// `packages/core/src/profiling/cpu-profiler.ts`. `node:inspector`'s Session API is a Node.js
// built-in, identical under NestJS or AdonisJS — this file has NO framework glue at all.
