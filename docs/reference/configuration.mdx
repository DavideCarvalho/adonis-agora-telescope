...
For reference, each package's `configure` command registers a provider in `adonisrc.ts`:

| Package                       | Provider import path                                              | Extra wiring                            |
| ----------------------------- | ---------------------------------------------------------------- | --------------------------------------- |
| `@agora/telescope`            | `@agora/telescope/telescope_provider`                            | `TelescopeMiddleware` on `server` stack |
| `@agora/telescope-watchers`   | `@agora/telescope-watchers/telescope_watchers_provider`          | —                                       |
| `@agora/telescope-ui`         | `@agora/telescope-ui/telescope_ui_provider`                      | routes registered at boot               |
| `@agora/telescope-alerts`     | `@agora/telescope-alerts/telescope_alerts_provider`              | —                                       |
| `@agora/telescope-ai`         | `@agora/telescope-ai/telescope_ai_provider`                      | binds `TelescopeAiDiagnoser`            |
