...
two distinctly so on-call can triage urgency at a glance: the **Slack** channel prepends
**🆕 New** or **🔁 Recurring** to the header. This matters most with the
...
| `isNew`                      | the **🆕 New** / **🔁 Recurring** header badge                          |
