...
description: The watchers subpath of @agora/telescope — record every Lucid SQL query (sql, bindings, duration, connection), every email sent, and @adonisjs/cache hit/miss/write/delete events, each correlated to the active request trace.
---
